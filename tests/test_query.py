...
class TestQuery(unittest.TestCase):
    ...
    def test_query_approaches_on_march_2(self):
        ...
        expected = set(approach for approach in self.approaches if approach.time.date() == date)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_approaches_after_april(self):
        ...
        expected = set(approach for approach in self.approaches if start_date <= approach.time.date())
        self.assertGreater(len(expected), 0)
    ...
    def test_query_approaches_before_july(self):
        ...
        expected = set(approach for approach in self.approaches if approach.time.date() <= end_date)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_approaches_in_march(self):
        ...
        expected = set(approach for approach in self.approaches if start_date <= approach.time.date() <= end_date)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_max_distance(self):
        ...
        expected = set(approach for approach in self.approaches if approach.distance <= distance_max)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_min_distance(self):
        ...
        expected = set(approach for approach in self.approaches if distance_min <= approach.distance)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_max_distance_and_min_distance(self):
        ...
        expected = set(approach for approach in self.approaches if distance_min <= approach.distance <= distance_max)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_max_velocity(self):
        ...
        expected = set(approach for approach in self.approaches if approach.velocity <= velocity_max)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_min_velocity(self):
        ...
        expected = set(approach for approach in self.approaches if velocity_min <= approach.velocity)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_max_velocity_and_min_velocity(self):
        ...
        expected = set(approach for approach in self.approaches if velocity_min <= approach.velocity <= velocity_max)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_max_diameter(self):
        ...
        expected = set(approach for approach in self.approaches if approach.neo.diameter <= diameter_max)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_min_diameter(self):
        ...
        expected = set(approach for approach in self.approaches if diameter_min <= approach.neo.diameter)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_max_diameter_and_min_diameter(self):
        ...
        expected = set(
            approach for approach in self.approaches if diameter_min <= approach.neo.diameter <= diameter_max
        )
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_hazardous(self):
        expected = set(approach for approach in self.approaches if approach.neo.hazardous)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_with_not_hazardous(self):
        expected = set(approach for approach in self.approaches if not approach.neo.hazardous)
        self.assertGreater(len(expected), 0)
    ...
    def test_query_approaches_in_march_with_min_distance_and_max_distance(self):
        ...
        expected = set(
            approach
            for approach in self.approaches
            if start_date <= approach.time.date() <= end_date and distance_min <= approach.distance <= distance_max
        )
        self.assertGreater(len(expected), 0)
